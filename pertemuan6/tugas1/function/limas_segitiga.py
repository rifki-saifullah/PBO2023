...
class limas_segitiga:
    def __init__(self, root):
        ...
        self.root.title("Kalkulator Limas Segitiga")
        self.component()

    def hitung_luas(self):
        alas = float(self.entry_alas.get())
        tinggi_alas = float(self.entry_tinggi_alas.get())
        tinggi_limas = float(self.entry_tinggi_limas.get())

        luas = (alas * tinggi_alas) / 2 + alas * math.sqrt((alas/2)**2 + tinggi_limas**2)
    ...
    def hitung_volume(self):
        ...
        volume = (alas**2 * tinggi_limas) / (3 * math.sqrt((alas/2)**2 + tinggi_limas**2))
    ...
    def component(self):
        ...
        # Alas
        label_alas = ttk.Label(frame, text="Alas")
        ...
        # Tinggi Alas
        label_tinggi_alas = ttk.Label(frame, text="Tinggi Alas")
        ...
        label_tinggi_limas.grid(row=2, column=0, sticky=tk.W, padx=5, pady=5)

        self.entry_tinggi_limas = ttk.Entry(frame)
        self.entry_tinggi_limas.grid(row=2, column=1)
